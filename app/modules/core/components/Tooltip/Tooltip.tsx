...
>(({ className, sideOffset = 5, children, ...props }, ref) => (
  ...
  >
    {children}
    <TooltipPrimitive.Arrow className="-my-0.5 fill-slate-900 shadow-md dark:fill-slate-100" />
  </TooltipPrimitive.Content>
));
